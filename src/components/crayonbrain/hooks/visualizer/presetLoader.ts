 ...
 * 
 * @param visualizer - Butterchurn visualizer instance
 * @param presets - Object containing preset data
 * @param presetIndex - Index of preset to load
 * @param blendTime - Time in seconds for preset transition
 * @returns Whether preset was successfully loaded
 */
export const loadPreset = (
  ...
  try {
    ...
    const presetError = new PresetLoadError('Failed to load preset', presetIndex, err as Error);
